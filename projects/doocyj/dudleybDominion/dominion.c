...
// refactored adventurer code called from cardEffect
int adventurerRefactor(struct gameState *state, int currentPlayer, int z){
...
// refactored sea hag code called from cardEffect
int seaHagRefactor(struct gameState *state, int currentPlayer){
	int i;
...
int treasureMapRefactor(struct gameState *state, int currentPlayer, int handPos){
...
int ambassadorRefactor(struct gameState *state, int currentPlayer, int choice2, int choice1, int handPos){
	int j;
	int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      return adventurerRefactor(state, currentPlayer, z);
    ...
    case smithy:
      return smithyRefactor(state, currentPlayer, handPos);
    ...
    case ambassador:
      return ambassadorRefactor(state, currentPlayer, choice2, choice1, handPos);
    ...
    case sea_hag:
      return seaHagRefactor(state, currentPlayer);
		
    case treasure_map:
      return treasureMapRefactor(state, currentPlayer, handPos);
    }
